<template>
    <div class="comment-tree">
        <div :style="indent">
            ...
            <comment v-if="comments.length > 0"  v-for="(comment, index) in comments" :key="index" :comments="comment.childComments" :label="comment.comment" :id="comment.id" :depth="depth + 1">
            </comment>
        </div>
    </div>
</template>
